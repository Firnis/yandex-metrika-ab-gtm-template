...
[
  {
    "type": "TEXT",
    "name": "counterId",
    "displayName": "counterId, который вы получили в Метрике",
    "simpleValueType": true
  },
  {
    "type": "TEXT",
    "name": "clientId",
    "displayName": "clientId, который вы получили в AB",
    "simpleValueType": true
  }
]
...
ymab(data.clientId, "init", function (answer) {
  ym(data.counterId, "experiments", answer.experiments);
});
...
Created on 13/07/2022, 15:18:37
